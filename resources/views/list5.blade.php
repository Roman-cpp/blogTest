                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4">
                            ...
                            <div class="single-post-content">
                                ...
                                <div class="featured-image">
                                    ...
                                    <div class="featured-image-overlay" style='background: lightblue url("../img/9.jpg") fixed center '></div>

                                    <div class="post-header">

                                        <div class="post-title">
                                            <h1 class="mb-0">Сверхмощные экзаваттные лазеры</h1>
                                        </div>
                                ...
                                <div class="post-content">
                                    ...
                                    <p class="mb-5">
                                        В 2006 году в Нижегородском Институте прикладной физики РАН ученые соорудили лазерную установку PEARL. Лазер способен выдать импульс с силой, в сотни раз превышающей мощность всех электростанций на планете. Сейчас учёные продолжают разрабатывать новые проекты по улучшению данной технологии. На основе подобных установок станет возможным создать лазерные источники нейтронов с уникальными свойствами.
                                    </p>
                                        ...
                                        <div class="post-pagination">
                                            ...
                                            <div class="pagination-no_spacing">
                                                ...
                                                <ul class="pagination">
                                                    ...
                                                    <li><a href="{{ route('list5') }}" class="active">5</a></li>
